        ...
        >
          ...
          <div className="w-full flex gap-2 justify-between">
            {info.socials.map((item, index) => (
              ...
              >
                <div
                  className={`lg:w-[80px] h-[80px] w-full bg-quaternary opacity-100 border-solid border-[2px] border-[#292929] border-t-1 border-b-0 border-l-0 border-r-0 hover:bg-[#0077b5] rounded-[24px] flex items-center justify-center cursor-pointer text-[#858585] hover:text-white duration-500 ${
                    item.name === "LinkedIn"
                      ? "hover:bg-[#0077b5]"
                      : item.name === "Github"
                      ? "hover:bg-[#181717]"
