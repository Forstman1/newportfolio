  ...
  return (
    ...
    >
      <div className="w-full flex flex-col justify-between gap-2 p-0 lg:p-[50px] px-0  items-center h-full">
        ...
        <p className="text-[28px] lg:text-[48px] text-center text-white">
          Who's the creative mind?
        </p>
        <div className=" flex lg:flex-row flex-col items-center  gap-8 mt-[50px]">
          <div className="h-full lg:w-[320px] w-[90%]  rounded-[24px] bg-primary items-center justify-center flex flex-col hover:rotate-[-4deg]	 duration-500 ">
            <Image
              src={avatar}
              alt="avatar"
